...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/Markdown-Converter.git`
...
```bash
# Clone the repo
git clone https://github.com/Qyroxen/Markdown-Converter.cd

# Install dependencies
go mod download

# Build
go build -o markdownconverter .
